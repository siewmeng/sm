...
You can use the [editor on GitHub](https://github.com/siewmeng/sm/edit/master/README.md) to maintain and preview the content for your website in Markdown files.
...
1. [enum](https://siewmeng.github.io/swift/file01_enum.md)
